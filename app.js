...
let MONGODB_URL='mongodb+srv://ankitashetti2909:OeymECXXgV0UGvTk@cluster0.9ytyv5a.mongodb.net/?retryWrites=true&w=majority'
...
//task 8 create  route  to see all product in product cart
...
app.post('/cart/add',async(req,res)=>{
    try{
        ...
        //find the product and add product price in total price in total
...
//task 10 create rout e to delete product in cart
